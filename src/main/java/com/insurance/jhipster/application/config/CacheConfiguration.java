package com.insurance.jhipster.application.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.insurance.jhipster.application.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.insurance.jhipster.application.repository.UserRepository.USERS_BY_EMAIL_CACHE);
