...
import com.insurance.jhipster.application.repository.ContentRepository;
...
/**
 * REST controller for managing {@link com.insurance.jhipster.application.domain.Content}.
 */
@RestController
@RequestMapping("/api")
