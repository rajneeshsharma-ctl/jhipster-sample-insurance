...
import com.insurance.jhipster.application.repository.DocumentRepository;
...
/**
 * REST controller for managing {@link com.insurance.jhipster.application.domain.Document}.
 */
@RestController
@RequestMapping("/api")
